...
#Basic solution to return the number of duplicates in the 
class Solution:
    def removeDuplicates(self, nums: List[int]) -> int:
        j = 1
        #This algorithm will help determine if there are any any duplicate and it will return amount of duplicates present in an array.
